...
public class ActivityMain extends AppCompatActivity implements MovieListener, MainFragment.OnFragmentInteractionListener, DetailedFragment.OnFragmentInteractionListener {
    boolean mTwoPane;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       setContentView(R.layout.new_main);
        FrameLayout twoPane = (FrameLayout) findViewById(R.id.frame_layout_detailed);
        if(null == twoPane)
            mTwoPane = false;
        else mTwoPane = true;
  ...
  */
        ...
        // this is accepted as the ActivityMain implements MovieListener
